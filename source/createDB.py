...
def createDB():
    ...
    with lite.connect('twitter.db') as con:
        ...
        cur.execute("CREATE TABLE Sessions(Name TEXT, State INTEGER, MKeyw TEXT, OKeyw TEXT, BKeyw TEXT, Since INTEGER, Lang TEXT, MaxHits INTEGER, DisplayZero INTEGER)")
